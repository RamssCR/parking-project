...
class VehicleModel {
    ...
    public function create_vehicle($vehicle, $customer, $employee) : int | bool {
        ...
        $insertVehicle = mysqli_execute_query($this->connection, 'INSERT INTO vehiculos (placa, marca, modelo, ano, id_cliente, id_empleado) VALUES(?, ?, ?, ?, ?, ?)', 
            [$vehicle['plate'], $vehicle['brand'], $vehicle['model'], $vehicle['year'], $customer, $employee]
        );
